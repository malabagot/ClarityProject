...
const finish_animation = document.getElementById("finishAnimation")

let wakeup_entered = false;
let fallasleep_entered = false;

function finished_sleep_questions() {
finish_box.classList.add('slideInAnimation');
fetch("/sleep",{
        method: "POST",
